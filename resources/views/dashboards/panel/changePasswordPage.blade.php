            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div style="padding-top: 3%" class="col-sm-8">
                                <form role="form" id="form" method="post" action="{{route('store_password')}}" class="form-horizontal">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-3">
                                            ...
                                            <a class="btn btn-primary" href="{{route('dashboard')}}"> بازگشت </a>
