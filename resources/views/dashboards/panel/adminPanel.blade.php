            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form role="form" id="form" method="POST" action="{{route('update_user_profile')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
...
{{--                                    </div>--}}
                                    ...
                                    <div style="padding-bottom: 30px" class="form-group">
                                        <label class="col-sm-2 control-label" for="userImage">عکس(فعلا کار نمیکنه)</label>
                                        <div class="col-sm-10">
...
{{--                                 background-repeat: no-repeat; background-size: contain; margin: 12px auto;display: block;position: relative;left: 25%; height: 164px;">--}}
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-sm-offset-0" style=" height: 20px; display: inline;">
                                        <a href="{{route('change_password')}}" class="btn btn-primary " >تغییر پسورد</a>
                                    </div>
                                    <div class="form-group col-sm-offset-0" style=" height: 20px; display: inline;">
